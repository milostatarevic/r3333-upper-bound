import PricingABD.Schedules.BTUU4Chunk00
import PricingABD.Schedules.BTUU4Chunk01
import PricingABD.Schedules.BTUU4Chunk02
import PricingABD.Schedules.BTUU4Chunk03
import PricingABD.Schedules.BTUU4Chunk04
import PricingABD.Schedules.BTUU4Chunk05
import PricingABD.Schedules.BTUU4Chunk06
import PricingABD.Schedules.BTUU4Chunk07
import PricingABD.Schedules.BTUU4Chunk08
import PricingABD.Schedules.BTUU4Chunk09
import PricingABD.Schedules.BTUU4Chunk10
import PricingABD.Schedules.BTUU4Chunk11
import PricingABD.Schedules.BTUU4Chunk12
import PricingABD.Schedules.BTUU4Chunk13
import PricingABD.Schedules.BTUU4Chunk14
import PricingABD.Schedules.BTUU4Chunk15
namespace PricingABD.Schedules.BTUU4Complete
open Ramsey61 Ramsey61.DenseCounter PricingABD.ABLayout PricingABD.ABGeometry PricingABD.ABProgram PricingABD.Schedules.BTUU4
...
set_option maxHeartbeats 0
 theorem fold_all : ∀i:Fin 488,FoldOK program types i := by
  ...
  ·
    ...
    simpa only [he] using PricingABD.Schedules.BTUU4Chunk00.fold j
  ·
    ...
    ·
      ...
      simpa only [he] using PricingABD.Schedules.BTUU4Chunk01.fold j
    ·
      ...
      ·
        ...
        simpa only [he] using PricingABD.Schedules.BTUU4Chunk02.fold j
      ·
        ...
        ·
          ...
          simpa only [he] using PricingABD.Schedules.BTUU4Chunk03.fold j
        ·
          ...
          ·
            ...
            simpa only [he] using PricingABD.Schedules.BTUU4Chunk04.fold j
          ·
            ...
            ·
              ...
              simpa only [he] using PricingABD.Schedules.BTUU4Chunk05.fold j
            ·
              ...
              ·
                ...
                simpa only [he] using PricingABD.Schedules.BTUU4Chunk06.fold j
              ·
                ...
                ·
                  ...
                  simpa only [he] using PricingABD.Schedules.BTUU4Chunk07.fold j
                ·
                  ...
                  ·
                    ...
                    simpa only [he] using PricingABD.Schedules.BTUU4Chunk08.fold j
                  ·
                    ...
                    ·
                      ...
                      simpa only [he] using PricingABD.Schedules.BTUU4Chunk09.fold j
                    ·
                      ...
                      ·
                        ...
                        simpa only [he] using PricingABD.Schedules.BTUU4Chunk10.fold j
                      ·
                        ...
                        ·
                          ...
                          simpa only [he] using PricingABD.Schedules.BTUU4Chunk11.fold j
                        ·
                          ...
                          ·
                            ...
                            simpa only [he] using PricingABD.Schedules.BTUU4Chunk12.fold j
                          ·
                            ...
                            ·
                              ...
                              simpa only [he] using PricingABD.Schedules.BTUU4Chunk13.fold j
                            ·
                              ...
                              ·
                                ...
                                simpa only [he] using PricingABD.Schedules.BTUU4Chunk14.fold j
                              ·
                                let j:Fin 8:=⟨i.val-480,by omega⟩
                                have he:(⟨480+j.val,by have hh:=j.isLt;omega⟩:Fin 488)=i := by apply Fin.ext;dsimp [j];omega
                                simpa only [he] using PricingABD.Schedules.BTUU4Chunk15.fold j
...
def Adjacent (i:Fin 432) : Prop := actualStart i.succ=actualStart i.castSucc+PricingIntegration.SparseCounter.offset (height i.castSucc) (inputs i.castSucc).length
 theorem adjacent_all : ∀i:Fin 432,Adjacent i := by
  ...
  ·
    ...
    have hj:Adjacent (⟨0+j.val,by have hh:=j.isLt;omega⟩) := PricingABD.Schedules.BTUU4Chunk00.adjacent j
  ...
  ·
    ...
    ·
      ...
      have hj:Adjacent (⟨32+j.val,by have hh:=j.isLt;omega⟩) := PricingABD.Schedules.BTUU4Chunk01.adjacent j
      simpa only [he] using hj
    ·
      by_cases h2:i.val<96
      ·
        ...
        have hj:Adjacent (⟨64+j.val,by have hh:=j.isLt;omega⟩) := PricingABD.Schedules.BTUU4Chunk02.adjacent j
        simpa only [he] using hj
      ·
        by_cases h3:i.val<128
        ·
          ...
          have hj:Adjacent (⟨96+j.val,by have hh:=j.isLt;omega⟩) := PricingABD.Schedules.BTUU4Chunk03.adjacent j
          simpa only [he] using hj
        ·
          by_cases h4:i.val<160
          ·
            ...
            have hj:Adjacent (⟨128+j.val,by have hh:=j.isLt;omega⟩) := PricingABD.Schedules.BTUU4Chunk04.adjacent j
            simpa only [he] using hj
          ·
            by_cases h5:i.val<192
            ·
              ...
              have hj:Adjacent (⟨160+j.val,by have hh:=j.isLt;omega⟩) := PricingABD.Schedules.BTUU4Chunk05.adjacent j
              simpa only [he] using hj
            ·
              by_cases h6:i.val<224
              ·
                ...
                have hj:Adjacent (⟨192+j.val,by have hh:=j.isLt;omega⟩) := PricingABD.Schedules.BTUU4Chunk06.adjacent j
                simpa only [he] using hj
              ·
                by_cases h7:i.val<256
                ·
                  ...
                  have hj:Adjacent (⟨224+j.val,by have hh:=j.isLt;omega⟩) := PricingABD.Schedules.BTUU4Chunk07.adjacent j
                  simpa only [he] using hj
                ·
                  by_cases h8:i.val<288
                  ·
                    ...
                    have hj:Adjacent (⟨256+j.val,by have hh:=j.isLt;omega⟩) := PricingABD.Schedules.BTUU4Chunk08.adjacent j
                    simpa only [he] using hj
                  ·
                    by_cases h9:i.val<320
                    ·
                      ...
                      have hj:Adjacent (⟨288+j.val,by have hh:=j.isLt;omega⟩) := PricingABD.Schedules.BTUU4Chunk09.adjacent j
                      simpa only [he] using hj
                    ·
                      by_cases h10:i.val<352
                      ·
                        ...
                        have hj:Adjacent (⟨320+j.val,by have hh:=j.isLt;omega⟩) := PricingABD.Schedules.BTUU4Chunk10.adjacent j
                        simpa only [he] using hj
                      ·
                        by_cases h11:i.val<384
                        ·
                          ...
                          have hj:Adjacent (⟨352+j.val,by have hh:=j.isLt;omega⟩) := PricingABD.Schedules.BTUU4Chunk11.adjacent j
                          simpa only [he] using hj
                        ·
                          by_cases h12:i.val<416
                          ·
                            ...
                            have hj:Adjacent (⟨384+j.val,by have hh:=j.isLt;omega⟩) := PricingABD.Schedules.BTUU4Chunk12.adjacent j
                            simpa only [he] using hj
                          ·
                            let j:Fin 16:=⟨i.val-416,by omega⟩
                            have he:(⟨416+j.val,by have hh:=j.isLt;omega⟩:Fin 432)=i := by apply Fin.ext;dsimp [j];omega
                            have hj:Adjacent (⟨416+j.val,by have hh:=j.isLt;omega⟩) := PricingABD.Schedules.BTUU4Chunk13.adjacent j
                            simpa only [he] using hj
...
end PricingABD.Schedules.BTUU4Complete
