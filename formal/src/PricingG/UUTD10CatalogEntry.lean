...
import PricingG.UUTD10SupportClassification
...
/-!
# Semantic entrance to the UUT / block-two catalogue
...
open UUTD10SupportClassification
...
theorem exists_catalogExactBranch_of_exact
  ...
  let normalized := PricingG.UUQSupportTransport.normalizeUUQExactDegreeTenSupports
    (by rfl) (by rfl) exact firstIndex secondIndex
    hfirst hsecond
