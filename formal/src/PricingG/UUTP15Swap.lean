...
import PricingG.UUTFourSwap
import PricingG.UUTP15Transport
...
theorem swapBlockZeroPositionEquiv_symm_preserves
  ...
  have h := ProfileDFourRowKindSymmetry.localK15Zero_preserves .uut
...
theorem swapBlockOnePositionEquiv_symm_preserves
    ...
    k15Template false (swapBlockOnePositionEquiv.symm left)
      ...
      k15Template false left right := by
  have h := ProfileDFourRowKindSymmetry.localK15One_preserves .uut
...
theorem swapRestore_templateCanonical (tail : Witness .uut) :
  ...
  · change left < 16 at hleft
    ...
    change tail.coloring
      ...
      canonicalPalette 3 (templateColor 16 true left right)
...
theorem q2SupportActionEquiv_inverse
    (representative : SupportRepresentative) (action : Fin 10) :
    UUTD10OrbitTransport.q2SupportActionEquiv
        representative
  ...
  apply Equiv.ext
  intro position
  apply (UUTD10OrbitTransport.q2SupportActionEquiv
