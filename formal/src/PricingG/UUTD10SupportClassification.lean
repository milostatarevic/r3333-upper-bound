...
/-!
# Support classification for UUT / block two / position fifteen / degree ten
...
The selected Q16 type is twisted throughout; the foreign cells remain U.
...
namespace R4333
namespace UUTD10SupportClassification
...
end UUTD10SupportClassification
end R4333
