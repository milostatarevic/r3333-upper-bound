import PricingG.UUTD9StrongStabilizer
import R4333Lean.ProfileDDegreeTenMatrixTransport61

/-!
# Physical symmetry transport for the strong UUU degree-nine case
...
theorem freeChoiceNormalizer_preserves_normalColor
    ...
    (left right : FiveVertex) (hne : left ≠ right) :
    strongFreeNormalColor (freeChoiceNormalizer source target left)
  ...
  change k15Template false (target.label left) (target.label right) = _
    at htarget
...
theorem freeChoiceNormalizer_preserves_cycle
  ...
  unfold strongFreeNormalColor at hnormal
