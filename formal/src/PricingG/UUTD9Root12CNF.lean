import PricingG.UUTD9Root12Case
...
`UUTD9Root12Case`.  A physical support pair consists of an
...
def twistedRoot12FreeLabelSet : Finset (Fin 15) :=
  colorNeighborhood (k15Template true) 0 12

def twistedRoot12LargeLabelSet : Finset (Fin 15) :=
  colorNeighborhood (k15Template true) 2 12

theorem twistedRoot12FreeLabelSet_card : twistedRoot12FreeLabelSet.card = 5 := by decide

theorem twistedRoot12LargeLabelSet_card : twistedRoot12LargeLabelSet.card = 5 := by decide

theorem twistedRoot12SmallLabelSet_card : twistedRoot12SmallLabelSet.card = 4 := by decide

def twistedRoot12PairOfSupports?
    (large small : Finset (Fin 15)) : Option StrongPair :=
  if hlarge : large ∈ twistedRoot12LargeSupportCandidates then
    if hsmall : small ∈ twistedRoot12CompatibleSmallSupportCandidates then
...
def twistedRoot12LargePhysicalColorMap : ThreeColor → ThreeColor := ![0, 1, 0]

def twistedRoot12LargePhysicalColoring : EdgeColoring (Fin 15) ThreeColor where
  color left right := twistedRoot12LargePhysicalColorMap
    (k15Template false left right)
  color_symm left right := by
    exact congrArg twistedRoot12LargePhysicalColorMap
...
def twistedRoot12FreeNormalColor (left right : FiveVertex) : ThreeColor :=
...
def freeLabelOrder : Fin 5 ≃ ↑twistedRoot12FreeLabelSet :=
  (Finset.orderIsoOfFin twistedRoot12FreeLabelSet twistedRoot12FreeLabelSet_card).toEquiv

def largeLabelOrder : Fin 5 ≃ ↑twistedRoot12LargeLabelSet :=
  (Finset.orderIsoOfFin twistedRoot12LargeLabelSet twistedRoot12LargeLabelSet_card).toEquiv

def smallLabelOrder : Fin 4 ≃ ↑twistedRoot12SmallLabelSet :=
  (Finset.orderIsoOfFin twistedRoot12SmallLabelSet twistedRoot12SmallLabelSet_card).toEquiv
...
def FreePermutationCompatible (freePerm : Equiv.Perm (Fin 5)) : Prop :=
  ∀ left right : FiveVertex, left ≠ right →
    k15Template true
      ...
      twistedRoot12FreeNormalColor left right
...
noncomputable def freeLabelEquiv (realization : TwistedRoot12Realization) :
    FiveVertex ≃ ↑twistedRoot12FreeLabelSet :=
  embeddingEquivRange
    ...
    twistedRoot12FreeLabelSet (by
      simpa [twistedRoot12FreeLabelSet] using realization.freeLabel_image)

noncomputable def largeLabelEquiv (realization : TwistedRoot12Realization) :
    FiveVertex ≃ ↑twistedRoot12LargeLabelSet :=
  embeddingEquivRange
    (⟨largeLabel realization, by
      ...
      apply restLabel_injective_local
      exact realization.normal.vertex.symm.injective h⟩)
    twistedRoot12LargeLabelSet (by
      simpa [twistedRoot12LargeLabelSet] using realization.largeLabel_image)

theorem TwistedRoot12Realization.largeTarget_eq_one
...
theorem TwistedRoot12Realization.largeTargetSize_eq_fifteen
    (realization : TwistedRoot12Realization) :
    blockSize (largeForeignBlock realization.branch.toSemantic.block
      realization.skeleton.firstLarge) = 15 := by
  rw [TwistedRoot12Realization.largeTarget_eq_one realization]
  rfl

noncomputable def largePhysicalEmbedding
    (realization : TwistedRoot12Realization) : Fin 5 ↪ Fin 15 where
  toFun index := Fin.cast
    (TwistedRoot12Realization.largeTargetSize_eq_fifteen realization)
...
noncomputable def twistedRoot12LargePhysicalSupport (realization : TwistedRoot12Realization) :
    Finset (Fin 15) :=
  Finset.univ.image (largePhysicalEmbedding realization)

theorem TwistedRoot12Realization.largePhysicalEmbedding_mem
    (realization : TwistedRoot12Realization) (index : Fin 5) :
  ...
  simpa [largePhysicalEmbedding,
    TwistedRoot12Realization.largeTarget_eq_one realization] using hcolor

theorem TwistedRoot12Realization.largePhysicalSupport_eq
    (realization : TwistedRoot12Realization) :
    twistedRoot12LargePhysicalSupport realization =
      twistedRoot12LargeSupport realization := by
  apply Finset.eq_of_subset_of_card_le
  · intro position hposition
    obtain ⟨index, _hindex, rfl⟩ := Finset.mem_image.mp hposition
    exact TwistedRoot12Realization.largePhysicalEmbedding_mem realization index
  · rw [show (twistedRoot12LargeSupport realization).card = 5 from
      (mem_independentSupportCandidates_iff 5 2
        (twistedRoot12LargeSupport realization)).mp
          realization.largeSupport_mem_candidates |>.1]
    simp [twistedRoot12LargePhysicalSupport,
      Finset.card_image_of_injective _
        (largePhysicalEmbedding realization).injective]

theorem TwistedRoot12Realization.largePhysicalSupport_mem_candidates
    (realization : TwistedRoot12Realization) :
    twistedRoot12LargePhysicalSupport realization ∈
      twistedRoot12LargeSupportCandidates := by
  rw [TwistedRoot12Realization.largePhysicalSupport_eq realization]
  exact realization.largeSupport_mem_candidates

noncomputable def twistedRoot12SupportPair
    (realization : TwistedRoot12Realization) : StrongPair :=
  ⟨⟨twistedRoot12LargePhysicalSupport realization,
      TwistedRoot12Realization.largePhysicalSupport_mem_candidates realization⟩,
...
noncomputable def largePhysicalEquiv
    (realization : TwistedRoot12Realization) :
    Fin 5 ≃ ↑(twistedRoot12LargePhysicalSupport realization) :=
  embeddingEquivRange (largePhysicalEmbedding realization)
    (twistedRoot12LargePhysicalSupport realization) rfl

theorem TwistedRoot12Realization.free_free_edge
    (realization : TwistedRoot12Realization) (left right : FiveVertex)
    (hlr : left ≠ right) :
...
private theorem decode_blockOne_template
    ...
    decodeNonBlockColor (blockRootColor 2) (canonicalPalette 2 q) =
      twistedRoot12LargePhysicalColorMap q := by
  fin_cases q
...
theorem TwistedRoot12Realization.large_large_edge_physical
    (realization : TwistedRoot12Realization) (left right : Fin 5)
    (hlr : left ≠ right) :
  ...
  have hleftMem : largePhysicalEmbedding realization left ∈
      twistedRoot12LargeSupport realization := by
    exact TwistedRoot12Realization.largePhysicalEmbedding_mem realization left
  have hrightMem : largePhysicalEmbedding realization right ∈
      twistedRoot12LargeSupport realization := by
    exact TwistedRoot12Realization.largePhysicalEmbedding_mem realization right
  have hindependent :=
    (mem_independentSupportCandidates_iff 5 2
      (twistedRoot12LargeSupport realization)).mp
  ...
  simpa [twistedRoot12LargePhysicalColoring] using hedge

/-! The canonical row transport, retaining its permutation explicitly. -/

structure CanonicalStrongData (realization : TwistedRoot12Realization) where
...
theorem exists_canonicalStrongData (realization : TwistedRoot12Realization) :
...
noncomputable def semanticFreeEquiv
    ...
    Fin 5 ≃ ↑twistedRoot12FreeLabelSet :=
...
noncomputable def semanticLargePairEquiv
    (realization : TwistedRoot12Realization) :
    Fin 5 ≃ ↑(twistedRoot12SupportPair realization).1.1 := by
  change Fin 5 ≃ ↑(twistedRoot12LargePhysicalSupport realization)
  exact semanticLargeEquiv realization

noncomputable def semanticSmallPairEquiv
    (realization : TwistedRoot12Realization) :
    Fin 4 ≃ ↑(twistedRoot12SupportPair realization).2.1 := by
  change Fin 4 ≃ ↑(twistedRoot12SmallSupport realization)
...
noncomputable def semanticAssignmentData
  ...
  largePerm := (semanticLargePairEquiv realization).trans
    (pairLargeOrder (twistedRoot12SupportPair realization)).symm
  smallPerm := (semanticSmallPairEquiv realization).trans
    (pairSmallOrder (twistedRoot12SupportPair realization)).symm
...
theorem semanticAssignmentData_largePhysical
    ...
    (semanticAssignmentData realization data).largePhysical
        (twistedRoot12SupportPair realization) index =
      largePhysicalEmbedding realization
        ((largeLabelEquiv realization).symm (largeLabelOrder index)) := by
  change (pairLargeOrder (twistedRoot12SupportPair realization)
    (((semanticLargePairEquiv realization).trans
      (pairLargeOrder (twistedRoot12SupportPair realization)).symm) index)).1 = _
  rw [Equiv.trans_apply, Equiv.apply_symm_apply]
...
theorem semanticAssignmentData_smallPhysical
    ...
    (semanticAssignmentData realization data).smallPhysical
      ...
      smallPhysicalEmbedding realization
        ((smallLabelEquiv realization).symm (smallLabelOrder index)) := by
  change (pairSmallOrder (twistedRoot12SupportPair realization)
    (((semanticSmallPairEquiv realization).trans
      (pairSmallOrder (twistedRoot12SupportPair realization)).symm) index)).1 = _
  rw [Equiv.trans_apply, Equiv.apply_symm_apply]
...
theorem decode_canonicalInside_eq_strongFreeNormalColor
    ...
    decodeNonBlockColor 3
      ...
      twistedRoot12FreeNormalColor left right := by
  by_cases hcycle : canonicalCycleWord.coloring left right
  · simp [twistedRoot12FreeNormalColor, hcycle, decodeRemainingColor,
...
theorem semanticAssignmentData_compatible
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization) :
    LocalAssignmentCompatible (twistedRoot12SupportPair realization)
  ...
  · intro left right hlr
    ...
    rw [semanticAssignmentData_freeLabel,
      ...
      TwistedRoot12Realization.free_free_edge realization (data.rowPerm left)
  ...
  · intro left right hlr
    ...
    change k15Template true
      ...
      twistedRoot12LargePhysicalColoring
        ((semanticAssignmentData realization data).largePhysical
          (twistedRoot12SupportPair realization) left)
        ((semanticAssignmentData realization data).largePhysical
          (twistedRoot12SupportPair realization) right)
    ...
    exact TwistedRoot12Realization.large_large_edge_physical realization
...
noncomputable def semanticAssignment
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization) :
    LocalAssignment (twistedRoot12SupportPair realization) :=
  ⟨semanticAssignmentData realization data,
    semanticAssignmentData_compatible realization data⟩

theorem TwistedRoot12Realization.smallSupport_eq_foreignZero
    (realization : TwistedRoot12Realization) :
    twistedRoot12SmallSupport realization =
...
theorem TwistedRoot12Realization.free_large_host_edge
    (realization : TwistedRoot12Realization) (free large : Fin 5) :
    realization.branch.toDegreeFlooredFiveExtension.toFiveExtension.rows
...
theorem TwistedRoot12Realization.free_small_host_edge
    (realization : TwistedRoot12Realization) (free : Fin 5) (small : Fin 4) :
    realization.branch.toDegreeFlooredFiveExtension.toFiveExtension.rows
        free (blockVertex 0
...
theorem TwistedRoot12Realization.large_small_host_edge
    (realization : TwistedRoot12Realization) (large : Fin 5) (small : Fin 4) :
    realization.branch.toDegreeFlooredFiveExtension.toFiveExtension.tail.coloring
...
theorem twistedRoot12BaseFmla_outside_selectorNamespace :
    FormulaOutsideNamespace selectorNamespaceTag
...
theorem twistedRoot12Fmla_outside_selectorNamespace :
    FormulaOutsideNamespace selectorNamespaceTag
  ...
  · exact twistedRoot12BaseFmla_outside_selectorNamespace
  · intro clause hclause literal hliteral
...
noncomputable def twistedRoot12FinalValuation
    (realization : TwistedRoot12Realization)
...
theorem twistedRoot12FinalValuation_ordinaryEdgeAtom
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization)
    (left right : TotalVertex) (hne : left ≠ right) (q : Fin 4) :
    twistedRoot12FinalValuation realization data
      ...
      totalColoring data.branch.toDegreeFlooredFiveExtension.toFiveExtension
        left right = q := by
  unfold twistedRoot12FinalValuation
...
private theorem twistedRoot12Realization_selectedBlockVertex
    (realization : TwistedRoot12Realization) :
    blockVertex realization.branch.toSemantic.block
        realization.branch.toSemantic.position.val =
      blockVertex 2 (Fin.last 15).val := by
  change blockVertex
      (uuuRepresentativeIndexBySlot (caseSlot twistedRoot12Case)).1
      (uuuRepresentativeIndexBySlot (caseSlot twistedRoot12Case)).2.val =
    blockVertex 2 (Fin.last 15).val
  simp [twistedRoot12Case, caseSlot, uuuRepresentativeIndexBySlot,
    ProfileDUUUFiveSupportPositionSymmetry.k16Index]

private theorem twistedRoot12Realization_selectedRootColor
    (realization : TwistedRoot12Realization) :
...
theorem CanonicalStrongData.blockZero_support_iff
    ...
    totalColoring data.branch.toDegreeFlooredFiveExtension.toFiveExtension
      ...
      position ∈ (twistedRoot12SupportPair realization).2.1 := by
  ...
  change realization.branch.toDegreeFlooredFiveExtension.toFiveExtension.tail.coloring
    ...
    position ∈ twistedRoot12SmallSupport realization
  rw [TwistedRoot12Realization.smallSupport_eq_foreignZero realization]
  have hmem :=
    (mem_foreignOwnSupport realization.branch.toSemantic 0 position).symm
  rw [twistedRoot12Realization_selectedBlockVertex realization,
    twistedRoot12Realization_selectedRootColor realization] at hmem
  exact hmem
...
theorem CanonicalStrongData.blockOne_support_iff
    ...
    totalColoring data.branch.toDegreeFlooredFiveExtension.toFiveExtension
      ...
      position ∈ (twistedRoot12SupportPair realization).1.1 := by
  unfold selectedVertex physicalBlockOneVertex
  rw [totalColoring_tail_tail, data.tail_eq]
  change realization.branch.toDegreeFlooredFiveExtension.toFiveExtension.tail.coloring
      (blockVertex 2 (Fin.last 15).val) (blockVertex 1 position.val) = 3 ↔
    position ∈ twistedRoot12LargePhysicalSupport realization
  rw [TwistedRoot12Realization.largePhysicalSupport_eq realization]
...
private theorem satisfies_support_clause
    ...
    (twistedRoot12FinalValuation realization data).satisfies
      [supportLiteral
        (OutsideDegreeCapCNF.outsideIncidentEdgeAtom
  ...
  · apply satisfies_of_mem_holds
    ...
    · change ¬twistedRoot12FinalValuation realization data
        (OutsideDegreeCapCNF.outsideIncidentEdgeAtom
          selectedVertex target (3 : Fin 4))
      rw [twistedRoot12FinalValuation_ordinaryEdgeAtom realization data
...
theorem twistedRoot12FinalValuation_satisfies_supportUnits
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot12FinalValuation realization data).satisfies_fmla
      (supportUnitClauses (twistedRoot12SupportPair realization)) := by
  constructor
  intro clause hclause
...
theorem semanticAssignment_freeLarge_edge
    ...
    totalColoring data.branch.toDegreeFlooredFiveExtension.toFiveExtension
        ...
        (physicalBlockOneVertex
          ((semanticAssignment realization data).1.largePhysical
            (twistedRoot12SupportPair realization) large)) =
  ...
  exact TwistedRoot12Realization.free_large_host_edge realization
    (data.rowPerm free)
...
theorem semanticAssignment_freeSmall_edge
    ...
    totalColoring data.branch.toDegreeFlooredFiveExtension.toFiveExtension
        ...
        (physicalBlockZeroVertex
          ((semanticAssignment realization data).1.smallPhysical
            (twistedRoot12SupportPair realization) small)) =
      decodedNormalHostColor
        (k15Template true
          ((semanticAssignment realization data).1.freeLabel free)
  ...
  exact TwistedRoot12Realization.free_small_host_edge realization
    (data.rowPerm free)
...
theorem semanticAssignment_largeSmall_edge
  ...
  rw [
    ...
    semanticAssignmentData_smallLabel realization data small,
    semanticAssignmentData_smallPhysical realization data small]
  exact TwistedRoot12Realization.large_small_host_edge realization
    ((largeLabelEquiv realization).symm (largeLabelOrder large))
    ((smallLabelEquiv realization).symm (smallLabelOrder small))

theorem twistedRoot12FinalValuation_satisfies_selectorFmla
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot12FinalValuation realization data).satisfies_fmla
      (selectorFmla (twistedRoot12SupportPair realization)) := by
  ...
  · have hsingle : clause = selectorAtLeastOneClause
        (twistedRoot12SupportPair realization) := List.mem_singleton.mp hatLeast
    subst clause
    apply satisfies_of_mem_holds
      (l := Sat.Literal.pos (selectorAtom selected))
    · change Sat.Literal.pos (selectorAtom selected) ∈
        (localAssignments (twistedRoot12SupportPair realization)).map
      ...
      · rcases List.mem_append.mp hfirstTwo with hfreeLarge | hfreeSmall
        · obtain ⟨free, _hfree, hlargeClause⟩ :=
          ...
          · change twistedRoot12FinalValuation realization data
            ...
            rw [twistedRoot12FinalValuation_ordinaryEdgeAtom realization data _ _
...
theorem twistedRoot12Realization_satisfies_pairFmla
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot12FinalValuation realization data).satisfies_fmla
      (pairFmla (twistedRoot12SupportPair realization)) := by
  constructor
  intro clause hclause
  ...
  · rcases List.mem_append.mp hleft with hbase | hsupport
    ...
    · exact (twistedRoot12FinalValuation_satisfies_supportUnits
        realization data).prop clause hsupport
  · exact (twistedRoot12FinalValuation_satisfies_selectorFmla
      realization data).prop clause hselector

theorem twistedRoot12Realization_yields_satisfying_pairFmla
    (realization : TwistedRoot12Realization) :
  ...
  exact ⟨twistedRoot12SupportPair realization,
    twistedRoot12FinalValuation realization data,
    twistedRoot12Realization_satisfies_pairFmla realization data⟩
...
theorem noStrongRealization_of_all_pair_lrat
    ...
    ¬Nonempty TwistedRoot12Realization := by
  rintro ⟨realization⟩
  obtain ⟨pair, valuation, hsatisfies⟩ :=
    twistedRoot12Realization_yields_satisfying_pairFmla realization
  exact hunsat pair valuation hsatisfies

#print axioms twistedRoot12FreeLabelSet_card
#print axioms twistedRoot12LargeLabelSet_card
#print axioms twistedRoot12SmallLabelSet_card
#print axioms supportUnitClauses_length
#print axioms guardedAssignmentClauses_length
#print axioms selectorFmla_length
#print axioms twistedRoot12Fmla_outside_selectorNamespace
#print axioms semanticAssignmentData_compatible
#print axioms twistedRoot12Realization_satisfies_pairFmla
