import PricingC.U16SupportData
namespace PricingC.U16SupportCover
open Finset
...
theorem four_entries_complete : entries4.reverse.map Prod.fst=(List.finRange 16).sublistsLen 4:=by decide +kernel
...
a prefiltered list assumed to contain every admissible physical support. -/
theorem five_entries_complete : entries5.reverse.map Prod.fst=(List.finRange 16).sublistsLen 5:=by decide +kernel
