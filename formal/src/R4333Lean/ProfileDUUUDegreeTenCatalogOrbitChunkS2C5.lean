...
theorem catalogNormalizerEquation_support2_chunk5 :
    ∀ offset : Fin 100,
      CatalogNormalizerEquationAt .support2 (catalogChunkIndex 5 offset) := by
  intro offset
  unfold CatalogNormalizerEquationAt
  fin_cases offset <;> decide +revert

#print axioms catalogNormalizerEquation_support2_chunk5
