...
theorem catalogNormalizerEquation_support2_chunk2 :
    ∀ offset : Fin 100,
      CatalogNormalizerEquationAt .support2 (catalogChunkIndex 2 offset) := by
  intro offset
  unfold CatalogNormalizerEquationAt
  fin_cases offset <;> decide +revert

#print axioms catalogNormalizerEquation_support2_chunk2
