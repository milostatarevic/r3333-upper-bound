...
namespace R4333
namespace ProfileDUUUFourSupportP15MatrixOnlyLeaves61
...
def matrixLeafFmla (leaf : OrderedLeaf) : Sat.Fmla :=
  ProfileDFourRowCNF.fmla .uuu ++ matrixUnitFmla leaf
...
theorem baseFmla_length :
    (ProfileDFourRowCNF.fmla .uuu).length = 87311 := by
  decide
...
end ProfileDUUUFourSupportP15MatrixOnlyLeaves61
end R4333
