...
namespace R4333
namespace ProfileDUUUFourSupportP15SemanticCatalogueResidualPair661
...
theorem residualExact_pair6 (root : RootCase)
    (first second : ReducedLabel) :
    ResidualExactAt (6 : Fin 9) root first second := by
  apply residualExact_of_upper
  unfold ResidualUpperExactAt residualCoordinate
  revert first second
  fin_cases root <;> decide

#print axioms residualExact_pair6

end ProfileDUUUFourSupportP15SemanticCatalogueResidualPair661
end R4333
