...
Twisted case (slot 3, firstLarge=false, twisted=true, root 1) — generated from
...
namespace R4333
namespace ContinuationDegreeNineTwistedRoot1Case61
...
noncomputable def twistedRoot1RootCase :
    DegreeNineTemplateRootCase (residualDeficientColor 3 false) :=
  ⟨true, ⟨1, by
    rw [residualTwistedRootRepresentativeSet 3 false]
    decide⟩⟩

noncomputable def twistedRoot1Case : ResidualCase :=
  ⟨3, false, twistedRoot1RootCase⟩

abbrev TwistedRoot1Realization := DegreeNineCaseRealization twistedRoot1Case

theorem TwistedRoot1Realization.firstLarge_eq_false
    (realization : TwistedRoot1Realization) :
    realization.skeleton.firstLarge = false := by
  simpa [twistedRoot1Case] using realization.caseFirstLarge_eq.symm

theorem TwistedRoot1Realization.twisted_eq_false
    (realization : TwistedRoot1Realization) :
    realization.normal.twisted = true := by
  simpa [twistedRoot1Case, twistedRoot1RootCase] using realization.caseTwisted_eq.symm

theorem TwistedRoot1Realization.rootLabel_eq_two
    (realization : TwistedRoot1Realization) :
    realization.normal.vertex.symm restoredRootLabel = 1 := by
  simpa [twistedRoot1Case, twistedRoot1RootCase] using realization.caseRoot_eq.symm

theorem TwistedRoot1Realization.branchBlock_eq_two
    (realization : TwistedRoot1Realization) :
    realization.branch.toSemantic.block = 2 := by
  change (uuuRepresentativeIndexBySlot (caseSlot twistedRoot1Case)).1 = 2
  simp [twistedRoot1Case, caseSlot, uuuRepresentativeIndexBySlot,
    ProfileDUUUFiveSupportPositionSymmetry.k16Index]

theorem TwistedRoot1Realization.freeDecodedColor_eq_zero
    (realization : TwistedRoot1Realization) :
...
theorem TwistedRoot1Realization.largeDecodedColor_eq_two
    (realization : TwistedRoot1Realization) :
...
theorem TwistedRoot1Realization.smallDecodedColor_eq_one
    (realization : TwistedRoot1Realization) :
...
def twistedRoot1LargeSupportCandidates : Finset (Finset (Fin 15)) :=
...
def twistedRoot1SmallSupportCandidates : Finset (Finset (Fin 15)) :=
  independentSupportCandidates 4 2

/-- The normalized four-set for the fixed untwisted root representative. -/
def twistedRoot1SmallLabelSet : Finset (Fin 15) :=
  colorNeighborhood (k15Template true) 1 1
...
def twistedRoot1SmallPhysicalColorMap : ThreeColor → ThreeColor := ![0, 2, 0]

def twistedRoot1SmallPhysicalColoring : EdgeColoring (Fin 15) ThreeColor where
  color left right := twistedRoot1SmallPhysicalColorMap
    (k15Template false left right)
  color_symm left right := by
    exact congrArg twistedRoot1SmallPhysicalColorMap
      ((k15Template false).color_symm left right)

def StrongSmallSupportCompatible (support : Finset (Fin 15)) : Prop :=
  ∃ equivalence : ↑twistedRoot1SmallLabelSet ≃ ↑support,
    ∀ left right, left ≠ right →
      k15Template true left.1 right.1 =
        twistedRoot1SmallPhysicalColoring (equivalence left).1
          (equivalence right).1
...
def twistedRoot1CompatibleSmallSupportCandidates : Finset (Finset (Fin 15)) :=
  twistedRoot1SmallSupportCandidates.filter StrongSmallSupportCompatible

theorem twistedRoot1LargeSupportCandidates_card :
    twistedRoot1LargeSupportCandidates.card = 11 := by
  decide

theorem twistedRoot1SmallSupportCandidates_card :
    twistedRoot1SmallSupportCandidates.card = 90 := by
  decide

theorem twistedRoot1CompatibleSmallSupportCandidates_card :
    twistedRoot1CompatibleSmallSupportCandidates.card = 60 := by
  decide

abbrev StrongPhysicalSupportPair :=
  ↑twistedRoot1LargeSupportCandidates ×
    ↑twistedRoot1CompatibleSmallSupportCandidates

theorem twistedRoot1PhysicalSupportPair_card :
    Fintype.card StrongPhysicalSupportPair = 660 := by
  simp [StrongPhysicalSupportPair, twistedRoot1LargeSupportCandidates_card,
    twistedRoot1CompatibleSmallSupportCandidates_card]

noncomputable def twistedRoot1LargeSupport (realization : TwistedRoot1Realization) :
    Finset (Fin 15) := by
...
noncomputable def smallPhysicalEmbedding
    (realization : TwistedRoot1Realization) : Fin 4 ↪ Fin 15 where
...
noncomputable def twistedRoot1SmallSupport (realization : TwistedRoot1Realization) :
    Finset (Fin 15) :=
...
private theorem support_blockOne_independent
  ...
  have hleft' : left ∈ foreignOwnSupport realization.branch.toSemantic 1 := by
    change left ∈ twistedRoot1LargeSupport realization
    exact hleft
  have hright' : right ∈ foreignOwnSupport realization.branch.toSemantic 1 := by
    change right ∈ twistedRoot1LargeSupport realization
    exact hright
...
private theorem support_blockZero_independent
    (realization : TwistedRoot1Realization) :
    IsColorIndependentSet (k15Template false) 2
      (twistedRoot1SmallSupport realization) := by
  intro left hleft right hright hlr
...
theorem TwistedRoot1Realization.largeSupport_mem_candidates
    (realization : TwistedRoot1Realization) :
    twistedRoot1LargeSupport realization ∈
      twistedRoot1LargeSupportCandidates := by
  change twistedRoot1LargeSupport realization ∈ independentSupportCandidates 5 2
...
theorem TwistedRoot1Realization.smallSupport_mem_candidates
    (realization : TwistedRoot1Realization) :
    twistedRoot1SmallSupport realization ∈
      twistedRoot1SmallSupportCandidates := by
  change twistedRoot1SmallSupport realization ∈ independentSupportCandidates 4 2
  rw [mem_independentSupportCandidates_iff]
  constructor
  · rw [twistedRoot1SmallSupport,
...
noncomputable def freeLabel (realization : TwistedRoot1Realization)
    (a : FiveVertex) : Fin 15 :=
  realization.normal.vertex.symm (restLabel (.inl (.inl a)))

noncomputable def largeLabel (realization : TwistedRoot1Realization)
    (a : FiveVertex) : Fin 15 :=
  realization.normal.vertex.symm (restLabel (.inl (.inr a)))

noncomputable def smallLabel (realization : TwistedRoot1Realization)
    (a : Fin 4) : Fin 15 :=
...
private theorem freeLabel_injective (realization : TwistedRoot1Realization) :
...
private theorem largeLabel_injective (realization : TwistedRoot1Realization) :
...
private theorem smallLabel_injective (realization : TwistedRoot1Realization) :
...
theorem TwistedRoot1Realization.smallPhysicalRange
    (realization : TwistedRoot1Realization) :
    Finset.univ.image (smallPhysicalEmbedding realization) =
      twistedRoot1SmallSupport realization := by
  rfl

theorem TwistedRoot1Realization.freeLabel_image
    (realization : TwistedRoot1Realization) :
    Finset.univ.image (freeLabel realization) =
      colorNeighborhood (k15Template true) 0 1 := by
...
theorem TwistedRoot1Realization.largeLabel_image
    (realization : TwistedRoot1Realization) :
    Finset.univ.image (largeLabel realization) =
      colorNeighborhood (k15Template true) 2 1 := by
  apply Finset.eq_of_subset_of_card_le
  · intro label hlabel
    obtain ⟨a, _ha, rfl⟩ := Finset.mem_image.mp hlabel
    apply (mem_colorNeighborhood _ _ _ _).2
...
theorem TwistedRoot1Realization.smallLabel_image
    (realization : TwistedRoot1Realization) :
    Finset.univ.image (smallLabel realization) =
      colorNeighborhood (k15Template true) 1 1 := by
  apply Finset.eq_of_subset_of_card_le
  · intro label hlabel
    obtain ⟨a, _ha, rfl⟩ := Finset.mem_image.mp hlabel
    apply (mem_colorNeighborhood _ _ _ _).2
...
noncomputable def templateLabel (realization : TwistedRoot1Realization)
    (x : RestCoordinates) : Fin 15 :=
  realization.normal.vertex.symm (restLabel x)

theorem templateEdge_eq_encoded_rest
    (realization : TwistedRoot1Realization) (x y : RestCoordinates)
    (hxy : x ≠ y) :
...
theorem TwistedRoot1Realization.small_small_edge
    (realization : TwistedRoot1Realization) (left right : Fin 4)
    (hlr : left ≠ right) :
...
private theorem decode_blockZero_template
    ...
    decodeNonBlockColor (blockRootColor 2) (canonicalPalette 1 q) =
      twistedRoot1SmallPhysicalColorMap q := by
  fin_cases q
...
theorem TwistedRoot1Realization.small_small_edge_physical
    (realization : TwistedRoot1Realization) (left right : Fin 4)
    (hlr : left ≠ right) :
    k15Template true (smallLabel realization left)
        (smallLabel realization right) =
  ...
  simpa [twistedRoot1SmallPhysicalColoring] using hedge'

noncomputable def smallLabelEquiv (realization : TwistedRoot1Realization) :
    Fin 4 ≃ ↑twistedRoot1SmallLabelSet :=
  embeddingEquivRange
    (⟨smallLabel realization, smallLabel_injective realization⟩)
    twistedRoot1SmallLabelSet (by
      simpa [twistedRoot1SmallLabelSet] using realization.smallLabel_image)

noncomputable def smallPhysicalEquiv (realization : TwistedRoot1Realization) :
    Fin 4 ≃ ↑(twistedRoot1SmallSupport realization) :=
  embeddingEquivRange (smallPhysicalEmbedding realization)
    (twistedRoot1SmallSupport realization) realization.smallPhysicalRange

theorem TwistedRoot1Realization.smallSupport_mem_compatibleCandidates
    (realization : TwistedRoot1Realization) :
    twistedRoot1SmallSupport realization ∈
      twistedRoot1CompatibleSmallSupportCandidates := by
...
theorem TwistedRoot1Realization.free_large_edge
    (realization : TwistedRoot1Realization) (free large : FiveVertex) :
...
theorem TwistedRoot1Realization.free_small_edge
    (realization : TwistedRoot1Realization) (free : FiveVertex) (small : Fin 4) :
    k15Template true (freeLabel realization free)
...
supports. -/
theorem TwistedRoot1Realization.large_small_edge
    (realization : TwistedRoot1Realization) (large : FiveVertex) (small : Fin 4) :
...
structure StrongCaseFiniteBoundary (realization : TwistedRoot1Realization) : Prop where
  largeSupport : twistedRoot1LargeSupport realization ∈
    twistedRoot1LargeSupportCandidates
  smallSupport : twistedRoot1SmallSupport realization ∈
    twistedRoot1CompatibleSmallSupportCandidates
...
theorem twistedRoot1CaseFiniteBoundary (realization : TwistedRoot1Realization) :
...
#print axioms twistedRoot1LargeSupportCandidates_card
#print axioms twistedRoot1SmallSupportCandidates_card
#print axioms twistedRoot1CompatibleSmallSupportCandidates_card
#print axioms twistedRoot1PhysicalSupportPair_card
#print axioms TwistedRoot1Realization.largeSupport_mem_candidates
#print axioms TwistedRoot1Realization.smallSupport_mem_candidates
#print axioms TwistedRoot1Realization.smallSupport_mem_compatibleCandidates
#print axioms TwistedRoot1Realization.small_small_edge_physical
#print axioms TwistedRoot1Realization.free_large_edge
#print axioms TwistedRoot1Realization.free_small_edge
#print axioms TwistedRoot1Realization.large_small_edge
#print axioms twistedRoot1CaseFiniteBoundary

end ContinuationDegreeNineTwistedRoot1Case61
end R4333
