...
theorem catalogNormalizerEquation_support0_chunk3 :
    ∀ offset : Fin 100,
      CatalogNormalizerEquationAt .support0 (catalogChunkIndex 3 offset) := by
  intro offset
  unfold CatalogNormalizerEquationAt
  fin_cases offset <;> decide +revert

#print axioms catalogNormalizerEquation_support0_chunk3
