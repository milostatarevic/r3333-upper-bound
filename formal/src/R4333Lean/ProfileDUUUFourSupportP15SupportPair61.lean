...
namespace R4333
namespace ProfileDUUUFourSupportP15SupportPair61
...
abbrev Branch :=
  PositionedFourSupport .uuu 2 SelectedPosition
...
noncomputable def normalizeSupports (branch : Branch)
  ...
  toDegreeFlooredFiveExtension :=
    transportDegreeFlooredFiveByTailPerm
      ...
      (ProfileDUUUDegreeTenSupportTransportUUU2P15.supportNormalizer_templateCanonical
...
end ProfileDUUUFourSupportP15SupportPair61
end R4333
