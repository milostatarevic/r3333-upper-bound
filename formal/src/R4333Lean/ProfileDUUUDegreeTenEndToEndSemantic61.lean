...
namespace R4333
namespace ProfileDUUUDegreeTenEndToEndSemantic61
...
every exact UUU/block-zero/position-zero degree-ten branch transports to one
...
theorem exists_representativeExactBranch_of_exact
    ...
    (exact : ExactDegreeTenMatrixBranch .uuu 0 SelectedPosition
      coordinates matrix) :
    ∃ leaf : ProfileDDegreeTenMatrixLeafTenDataUUU0.Leaf,
      Nonempty (RepresentativeExactBranch leaf) := by
...
end ProfileDUUUDegreeTenEndToEndSemantic61
end R4333
