import R4333Lean.ContinuationDegreeNineTwistedRoot12CaseCNF61
...
namespace R4333
namespace ContinuationDegreeNineTwistedRoot12CaseFactorCNF61
...
abbrev LargeFactorSupport := ↑twistedRoot12LargeSupportCandidates
abbrev SmallFactorSupport := ↑twistedRoot12CompatibleSmallSupportCandidates
...
theorem indexedLargeSupport_surjective :
  ...
  exact ((Fintype.bijective_iff_injective_and_card
    indexedLargeSupport).2 ⟨indexedLargeSupport_injective, by
      simp [LargeFactorSupport, twistedRoot12LargeSupportCandidates_card]⟩).2
  ...
  exact ((Fintype.bijective_iff_injective_and_card
    indexedSmallSupport).2 ⟨indexedSmallSupport_injective, by
      simp [SmallFactorSupport,
        twistedRoot12CompatibleSmallSupportCandidates_card]⟩).2
...
noncomputable def semanticLargeFactorChoice
  ...
  support := ⟨twistedRoot12LargePhysicalSupport realization,
    ...
    have horder :
        largeFactorOrder
            ⟨twistedRoot12LargePhysicalSupport realization,
              TwistedRoot12Realization.largePhysicalSupport_mem_candidates
                realization⟩ =
          pairLargeOrder (twistedRoot12SupportPair realization) := by
      rfl
...
noncomputable def semanticSmallFactorChoice
  ...
  support := ⟨twistedRoot12SmallSupport realization,
    ...
    have horder :
        smallFactorOrder
            ⟨twistedRoot12SmallSupport realization,
              realization.smallSupport_mem_compatibleCandidates⟩ =
          pairSmallOrder (twistedRoot12SupportPair realization) := by
      rfl
    intro left right hlr
...
theorem semanticLargeFactorChoice_physical
    ...
    (semanticLargeFactorChoice realization data).physical large =
      (semanticAssignment realization data).1.largePhysical
        (twistedRoot12SupportPair realization) large := by
  rfl
...
theorem semanticSmallFactorChoice_physical
    ...
    (semanticSmallFactorChoice realization data).physical small =
      (semanticAssignment realization data).1.smallPhysical
        (twistedRoot12SupportPair realization) small := by
  rfl
...
def factorFmla : Sat.Fmla :=
  fmla .uuu 2 (Fin.last 15) ++ factorSelectorFmla
...
noncomputable def twistedRoot12FactorFinalValuation
    (realization : TwistedRoot12Realization)
...
theorem twistedRoot12FactorFinalValuation_ordinaryEdgeAtom
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization)
    (left right : TotalVertex) (hne : left ≠ right) (q : Fin 4) :
    twistedRoot12FactorFinalValuation realization data
      ...
      totalColoring data.branch.toDegreeFlooredFiveExtension.toFiveExtension
        left right = q := by
  unfold twistedRoot12FactorFinalValuation
...
theorem twistedRoot12FactorFinalValuation_satisfies_atLeastOne
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot12FactorFinalValuation realization data).satisfies_fmla
      [freeFactorAtLeastOneClause,
       largeFactorAtLeastOneClause,
...
theorem twistedRoot12FactorFinalValuation_satisfies_freeAtMostOne
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot12FactorFinalValuation realization data).satisfies_fmla
  ...
  · apply satisfies_of_mem_holds
    ...
    · change ¬twistedRoot12FactorFinalValuation realization data
        (factorSelectorAtom 0 right)
      rw [show twistedRoot12FactorFinalValuation realization data =
...
theorem twistedRoot12FactorFinalValuation_satisfies_largeAtMostOne
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot12FactorFinalValuation realization data).satisfies_fmla
...
theorem twistedRoot12FactorFinalValuation_satisfies_smallAtMostOne
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot12FactorFinalValuation realization data).satisfies_fmla
...
private theorem factor_satisfies_guarded_support_selected
    ...
    (twistedRoot12FactorFinalValuation realization data).satisfies
      [Sat.Literal.neg selector,
       supportLiteral
        (OutsideDegreeCapCNF.outsideIncidentEdgeAtom
  ...
  · apply satisfies_of_mem_holds
    ...
    · change ¬twistedRoot12FactorFinalValuation realization data
        (OutsideDegreeCapCNF.outsideIncidentEdgeAtom
          selectedVertex target (3 : Fin 4))
      rw [twistedRoot12FactorFinalValuation_ordinaryEdgeAtom realization data
...
theorem twistedRoot12FactorFinalValuation_satisfies_supportFmla
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot12FactorFinalValuation realization data).satisfies_fmla
  ...
  · obtain ⟨choice, _hchoice, hpositionClause⟩ :=
    ...
    · subst choice
      ...
      simpa [semanticLargeFactorChoice, twistedRoot12SupportPair] using
  ...
  · obtain ⟨choice, _hchoice, hpositionClause⟩ :=
    ...
    · subst choice
      ...
      simpa [semanticSmallFactorChoice, twistedRoot12SupportPair] using
...
theorem twistedRoot12FactorFinalValuation_satisfies_crossFmla
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot12FactorFinalValuation realization data).satisfies_fmla
      factorCrossFmla := by
...
theorem twistedRoot12FactorFinalValuation_satisfies_selectorFmla
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot12FactorFinalValuation realization data).satisfies_fmla
    ...
    · rcases List.mem_append.mp hthroughSmallAmo with hthroughLargeAmo | hsmallAmo
      · rcases List.mem_append.mp hthroughLargeAmo with hthroughFreeAmo | hlargeAmo
        · rcases List.mem_append.mp hthroughFreeAmo with hatLeast | hfreeAmo
          · exact (twistedRoot12FactorFinalValuation_satisfies_atLeastOne
              realization data).prop clause hatLeast
          · exact (twistedRoot12FactorFinalValuation_satisfies_freeAtMostOne
              realization data).prop clause hfreeAmo
        · exact (twistedRoot12FactorFinalValuation_satisfies_largeAtMostOne
            realization data).prop clause hlargeAmo
      · exact (twistedRoot12FactorFinalValuation_satisfies_smallAtMostOne
          realization data).prop clause hsmallAmo
    · exact (twistedRoot12FactorFinalValuation_satisfies_supportFmla
        realization data).prop clause hsupport
  · exact (twistedRoot12FactorFinalValuation_satisfies_crossFmla
      realization data).prop clause hcross

theorem twistedRoot12Realization_satisfies_factorFmla
    (realization : TwistedRoot12Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot12FactorFinalValuation realization data).satisfies_fmla
      factorFmla := by
  ...
  · exact (twistedRoot12FactorFinalValuation_satisfies_selectorFmla
      realization data).prop clause hfactor

theorem twistedRoot12Realization_yields_satisfying_factorFmla
    (realization : TwistedRoot12Realization) :
    ∃ valuation : Sat.Valuation, valuation.satisfies_fmla factorFmla := by
  obtain ⟨data⟩ := exists_canonicalStrongData realization
  exact ⟨twistedRoot12FactorFinalValuation realization data,
    twistedRoot12Realization_satisfies_factorFmla realization data⟩
...
theorem noStrongRealization_of_factor_lrat
  ...
  obtain ⟨valuation, hsatisfies⟩ :=
    twistedRoot12Realization_yields_satisfying_factorFmla realization
...
#print axioms twistedRoot12Realization_satisfies_factorFmla
#print axioms noStrongRealization_of_factor_lrat

end ContinuationDegreeNineTwistedRoot12CaseFactorCNF61
end R4333
