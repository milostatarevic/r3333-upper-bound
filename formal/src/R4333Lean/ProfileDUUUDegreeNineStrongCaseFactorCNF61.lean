import R4333Lean.ProfileDUUUDegreeNineStrongCaseCNF61
...
namespace R4333
namespace ProfileDUUUDegreeNineStrongCaseFactorCNF61
...
abbrev LargeFactorSupport := ↑strongLargeSupportCandidates
abbrev SmallFactorSupport := ↑strongCompatibleSmallSupportCandidates
...
theorem indexedLargeSupport_surjective :
  ...
  exact ((Fintype.bijective_iff_injective_and_card
    indexedLargeSupport).2 ⟨indexedLargeSupport_injective, by
      simp [LargeFactorSupport, strongLargeSupportCandidates_card]⟩).2
  ...
  exact ((Fintype.bijective_iff_injective_and_card
    indexedSmallSupport).2 ⟨indexedSmallSupport_injective, by
      simp [SmallFactorSupport,
        strongCompatibleSmallSupportCandidates_card]⟩).2
...
noncomputable def semanticLargeFactorChoice
  ...
  support := ⟨strongLargePhysicalSupport realization,
    ...
    have horder :
        largeFactorOrder
            ⟨strongLargePhysicalSupport realization,
              StrongRealization.largePhysicalSupport_mem_candidates
                realization⟩ =
          pairLargeOrder (strongSupportPair realization) := by
      rfl
...
noncomputable def semanticSmallFactorChoice
  ...
  support := ⟨strongSmallSupport realization,
    ...
    have horder :
        smallFactorOrder
            ⟨strongSmallSupport realization,
              realization.smallSupport_mem_compatibleCandidates⟩ =
          pairSmallOrder (strongSupportPair realization) := by
      rfl
    intro left right hlr
...
theorem semanticLargeFactorChoice_physical
    ...
    (semanticLargeFactorChoice realization data).physical large =
      (semanticAssignment realization data).1.largePhysical
        (strongSupportPair realization) large := by
  rfl
...
theorem semanticSmallFactorChoice_physical
    ...
    (semanticSmallFactorChoice realization data).physical small =
      (semanticAssignment realization data).1.smallPhysical
        (strongSupportPair realization) small := by
  rfl
  ...
  (List.finRange 5).flatMap fun freeIndex : FiveVertex =>
    (List.finRange 5).map fun largeIndex : Fin 5 =>
      factorGuardedEdgeClause
        ...
        (k15Template false (free.label freeIndex)
  ...
  (List.finRange 5).flatMap fun largeIndex : Fin 5 =>
    (List.finRange 4).map fun smallIndex : Fin 4 =>
      factorGuardedEdgeClause
        ...
        (physicalBlockOneVertex (large.physical largeIndex))
        (physicalBlockZeroVertex (small.physical smallIndex))
        (k15Template false (large.label largeIndex)
          (small.label smallIndex))
...
noncomputable def strongFactorFinalValuation
    (realization : StrongRealization)
...
theorem strongFactorFinalValuation_ordinaryEdgeAtom
    (realization : StrongRealization)
    (data : CanonicalStrongData realization)
    (left right : TotalVertex) (hne : left ≠ right) (q : Fin 4) :
    strongFactorFinalValuation realization data
      ...
      totalColoring data.branch.toDegreeFlooredFiveExtension.toFiveExtension
        left right = q := by
  unfold strongFactorFinalValuation
...
theorem strongFactorFinalValuation_satisfies_atLeastOne
    (realization : StrongRealization)
    (data : CanonicalStrongData realization) :
    (strongFactorFinalValuation realization data).satisfies_fmla
      [freeFactorAtLeastOneClause,
       largeFactorAtLeastOneClause,
...
theorem strongFactorFinalValuation_satisfies_freeAtMostOne
    (realization : StrongRealization)
    (data : CanonicalStrongData realization) :
    (strongFactorFinalValuation realization data).satisfies_fmla
  ...
  · apply satisfies_of_mem_holds
    ...
    · change ¬strongFactorFinalValuation realization data
        (factorSelectorAtom 0 right)
      rw [show strongFactorFinalValuation realization data =
...
theorem strongFactorFinalValuation_satisfies_largeAtMostOne
    (realization : StrongRealization)
    (data : CanonicalStrongData realization) :
    (strongFactorFinalValuation realization data).satisfies_fmla
...
theorem strongFactorFinalValuation_satisfies_smallAtMostOne
    (realization : StrongRealization)
    (data : CanonicalStrongData realization) :
    (strongFactorFinalValuation realization data).satisfies_fmla
...
private theorem factor_satisfies_guarded_support_selected
    ...
    (strongFactorFinalValuation realization data).satisfies
      [Sat.Literal.neg selector,
       supportLiteral
        (OutsideDegreeCapCNF.outsideIncidentEdgeAtom
  ...
  · apply satisfies_of_mem_holds
    ...
    · change ¬strongFactorFinalValuation realization data
        (OutsideDegreeCapCNF.outsideIncidentEdgeAtom
          selectedVertex target (3 : Fin 4))
      rw [strongFactorFinalValuation_ordinaryEdgeAtom realization data
...
theorem strongFactorFinalValuation_satisfies_supportFmla
    (realization : StrongRealization)
    (data : CanonicalStrongData realization) :
    (strongFactorFinalValuation realization data).satisfies_fmla
  ...
  · obtain ⟨choice, _hchoice, hpositionClause⟩ :=
    ...
    · subst choice
      ...
      simpa [semanticLargeFactorChoice, strongSupportPair] using
  ...
  · obtain ⟨choice, _hchoice, hpositionClause⟩ :=
    ...
    · subst choice
      ...
      simpa [semanticSmallFactorChoice, strongSupportPair] using
...
theorem strongFactorFinalValuation_satisfies_crossFmla
    (realization : StrongRealization)
    (data : CanonicalStrongData realization) :
    (strongFactorFinalValuation realization data).satisfies_fmla
      factorCrossFmla := by
...
theorem strongFactorFinalValuation_satisfies_selectorFmla
    (realization : StrongRealization)
    (data : CanonicalStrongData realization) :
    (strongFactorFinalValuation realization data).satisfies_fmla
    ...
    · rcases List.mem_append.mp hthroughSmallAmo with hthroughLargeAmo | hsmallAmo
      · rcases List.mem_append.mp hthroughLargeAmo with hthroughFreeAmo | hlargeAmo
        · rcases List.mem_append.mp hthroughFreeAmo with hatLeast | hfreeAmo
          · exact (strongFactorFinalValuation_satisfies_atLeastOne
              realization data).prop clause hatLeast
          · exact (strongFactorFinalValuation_satisfies_freeAtMostOne
              realization data).prop clause hfreeAmo
        · exact (strongFactorFinalValuation_satisfies_largeAtMostOne
            realization data).prop clause hlargeAmo
      · exact (strongFactorFinalValuation_satisfies_smallAtMostOne
          realization data).prop clause hsmallAmo
    · exact (strongFactorFinalValuation_satisfies_supportFmla
        realization data).prop clause hsupport
  · exact (strongFactorFinalValuation_satisfies_crossFmla
      realization data).prop clause hcross

theorem strongRealization_satisfies_factorFmla
    (realization : StrongRealization)
    (data : CanonicalStrongData realization) :
    (strongFactorFinalValuation realization data).satisfies_fmla
      factorFmla := by
  ...
  · exact (strongFactorFinalValuation_satisfies_selectorFmla
      realization data).prop clause hfactor

theorem strongRealization_yields_satisfying_factorFmla
    (realization : StrongRealization) :
    ∃ valuation : Sat.Valuation, valuation.satisfies_fmla factorFmla := by
  obtain ⟨data⟩ := exists_canonicalStrongData realization
  exact ⟨strongFactorFinalValuation realization data,
    strongRealization_satisfies_factorFmla realization data⟩
...
theorem noStrongRealization_of_factor_lrat
  ...
  obtain ⟨valuation, hsatisfies⟩ :=
    strongRealization_yields_satisfying_factorFmla realization
...
#print axioms strongRealization_satisfies_factorFmla
#print axioms noStrongRealization_of_factor_lrat

end ProfileDUUUDegreeNineStrongCaseFactorCNF61
end R4333
