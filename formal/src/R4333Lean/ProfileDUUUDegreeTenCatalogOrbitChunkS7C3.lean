...
theorem catalogNormalizerEquation_support7_chunk3 :
    ∀ offset : Fin 100,
      CatalogNormalizerEquationAt .support7 (catalogChunkIndex 3 offset) := by
  intro offset
  unfold CatalogNormalizerEquationAt
  fin_cases offset <;> decide +revert

#print axioms catalogNormalizerEquation_support7_chunk3
