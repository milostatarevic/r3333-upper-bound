import R4333Lean.ContinuationDegreeNineTwistedRoot1CaseCNF61
...
namespace R4333
namespace ContinuationDegreeNineTwistedRoot1CaseFactorCNF61
...
abbrev LargeFactorSupport := ↑twistedRoot1LargeSupportCandidates
abbrev SmallFactorSupport := ↑twistedRoot1CompatibleSmallSupportCandidates
...
theorem indexedLargeSupport_surjective :
  ...
  exact ((Fintype.bijective_iff_injective_and_card
    indexedLargeSupport).2 ⟨indexedLargeSupport_injective, by
      simp [LargeFactorSupport, twistedRoot1LargeSupportCandidates_card]⟩).2
  ...
  exact ((Fintype.bijective_iff_injective_and_card
    indexedSmallSupport).2 ⟨indexedSmallSupport_injective, by
      simp [SmallFactorSupport,
        twistedRoot1CompatibleSmallSupportCandidates_card]⟩).2
...
noncomputable def semanticLargeFactorChoice
  ...
  support := ⟨twistedRoot1LargePhysicalSupport realization,
    ...
    have horder :
        largeFactorOrder
            ⟨twistedRoot1LargePhysicalSupport realization,
              TwistedRoot1Realization.largePhysicalSupport_mem_candidates
                realization⟩ =
          pairLargeOrder (twistedRoot1SupportPair realization) := by
      rfl
...
noncomputable def semanticSmallFactorChoice
  ...
  support := ⟨twistedRoot1SmallSupport realization,
    ...
    have horder :
        smallFactorOrder
            ⟨twistedRoot1SmallSupport realization,
              realization.smallSupport_mem_compatibleCandidates⟩ =
          pairSmallOrder (twistedRoot1SupportPair realization) := by
      rfl
    intro left right hlr
...
theorem semanticLargeFactorChoice_physical
    ...
    (semanticLargeFactorChoice realization data).physical large =
      (semanticAssignment realization data).1.largePhysical
        (twistedRoot1SupportPair realization) large := by
  rfl
...
theorem semanticSmallFactorChoice_physical
    ...
    (semanticSmallFactorChoice realization data).physical small =
      (semanticAssignment realization data).1.smallPhysical
        (twistedRoot1SupportPair realization) small := by
  rfl
...
noncomputable def twistedRoot1FactorFinalValuation
    (realization : TwistedRoot1Realization)
...
theorem twistedRoot1FactorFinalValuation_ordinaryEdgeAtom
    (realization : TwistedRoot1Realization)
    (data : CanonicalStrongData realization)
    (left right : TotalVertex) (hne : left ≠ right) (q : Fin 4) :
    twistedRoot1FactorFinalValuation realization data
      ...
      totalColoring data.branch.toDegreeFlooredFiveExtension.toFiveExtension
        left right = q := by
  unfold twistedRoot1FactorFinalValuation
...
theorem twistedRoot1FactorFinalValuation_satisfies_atLeastOne
    (realization : TwistedRoot1Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot1FactorFinalValuation realization data).satisfies_fmla
      [freeFactorAtLeastOneClause,
       largeFactorAtLeastOneClause,
...
theorem twistedRoot1FactorFinalValuation_satisfies_freeAtMostOne
    (realization : TwistedRoot1Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot1FactorFinalValuation realization data).satisfies_fmla
  ...
  · apply satisfies_of_mem_holds
    ...
    · change ¬twistedRoot1FactorFinalValuation realization data
        (factorSelectorAtom 0 right)
      rw [show twistedRoot1FactorFinalValuation realization data =
...
theorem twistedRoot1FactorFinalValuation_satisfies_largeAtMostOne
    (realization : TwistedRoot1Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot1FactorFinalValuation realization data).satisfies_fmla
...
theorem twistedRoot1FactorFinalValuation_satisfies_smallAtMostOne
    (realization : TwistedRoot1Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot1FactorFinalValuation realization data).satisfies_fmla
...
private theorem factor_satisfies_guarded_support_selected
    ...
    (twistedRoot1FactorFinalValuation realization data).satisfies
      [Sat.Literal.neg selector,
       supportLiteral
        (OutsideDegreeCapCNF.outsideIncidentEdgeAtom
  ...
  · apply satisfies_of_mem_holds
    ...
    · change ¬twistedRoot1FactorFinalValuation realization data
        (OutsideDegreeCapCNF.outsideIncidentEdgeAtom
          selectedVertex target (3 : Fin 4))
      rw [twistedRoot1FactorFinalValuation_ordinaryEdgeAtom realization data
...
theorem twistedRoot1FactorFinalValuation_satisfies_supportFmla
    (realization : TwistedRoot1Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot1FactorFinalValuation realization data).satisfies_fmla
...
theorem twistedRoot1FactorFinalValuation_satisfies_crossFmla
    (realization : TwistedRoot1Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot1FactorFinalValuation realization data).satisfies_fmla
      factorCrossFmla := by
...
theorem twistedRoot1FactorFinalValuation_satisfies_selectorFmla
    (realization : TwistedRoot1Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot1FactorFinalValuation realization data).satisfies_fmla
    ...
    · rcases List.mem_append.mp hthroughSmallAmo with hthroughLargeAmo | hsmallAmo
      · rcases List.mem_append.mp hthroughLargeAmo with hthroughFreeAmo | hlargeAmo
        · rcases List.mem_append.mp hthroughFreeAmo with hatLeast | hfreeAmo
          · exact (twistedRoot1FactorFinalValuation_satisfies_atLeastOne
              realization data).prop clause hatLeast
          · exact (twistedRoot1FactorFinalValuation_satisfies_freeAtMostOne
              realization data).prop clause hfreeAmo
        · exact (twistedRoot1FactorFinalValuation_satisfies_largeAtMostOne
            realization data).prop clause hlargeAmo
      · exact (twistedRoot1FactorFinalValuation_satisfies_smallAtMostOne
          realization data).prop clause hsmallAmo
    · exact (twistedRoot1FactorFinalValuation_satisfies_supportFmla
        realization data).prop clause hsupport
  · exact (twistedRoot1FactorFinalValuation_satisfies_crossFmla
      realization data).prop clause hcross

theorem twistedRoot1Realization_satisfies_factorFmla
    (realization : TwistedRoot1Realization)
    (data : CanonicalStrongData realization) :
    (twistedRoot1FactorFinalValuation realization data).satisfies_fmla
      factorFmla := by
  ...
  · exact (twistedRoot1FactorFinalValuation_satisfies_selectorFmla
      realization data).prop clause hfactor

theorem twistedRoot1Realization_yields_satisfying_factorFmla
    (realization : TwistedRoot1Realization) :
    ∃ valuation : Sat.Valuation, valuation.satisfies_fmla factorFmla := by
  obtain ⟨data⟩ := exists_canonicalStrongData realization
  exact ⟨twistedRoot1FactorFinalValuation realization data,
    twistedRoot1Realization_satisfies_factorFmla realization data⟩
...
theorem noStrongRealization_of_factor_lrat
  ...
  obtain ⟨valuation, hsatisfies⟩ :=
    twistedRoot1Realization_yields_satisfying_factorFmla realization
...
#print axioms twistedRoot1Realization_satisfies_factorFmla
#print axioms noStrongRealization_of_factor_lrat

end ContinuationDegreeNineTwistedRoot1CaseFactorCNF61
end R4333
