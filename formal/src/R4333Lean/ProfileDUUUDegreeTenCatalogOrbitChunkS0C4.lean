...
theorem catalogNormalizerEquation_support0_chunk4 :
    ∀ offset : Fin 100,
      CatalogNormalizerEquationAt .support0 (catalogChunkIndex 4 offset) := by
  intro offset
  unfold CatalogNormalizerEquationAt
  fin_cases offset <;> decide +revert

#print axioms catalogNormalizerEquation_support0_chunk4
