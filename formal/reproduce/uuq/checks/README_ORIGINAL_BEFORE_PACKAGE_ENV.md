...
From the compiled Lean project's environment, adjusting the explicit paths:

```sh
lake env lean -j1 --run path/to/uuq/EmitUUQ.lean run/uuq_suffixes
python3 path/to/uuq/compare.py \
